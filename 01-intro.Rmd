...
```{r weightplot-2,echo=FALSE, include=TRUE,message=FALSE, warnings=FALSE, fig.cap="Random fluctuations in Bridget Jones' weight, measured to the nearest pound",out.width="75%"}
